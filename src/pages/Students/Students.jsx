...
export default function Students(){
    ...
    return(
        <div className={styles.container}>
            ...
            <p>&nbsp;</p>
            <p>{t('students.shift1','1 ауысым')}</p>
            <table border="1px" className={styles.timetable}>
            <tbody>
            <tr>
            <td width="159">{t('students.double_lesson','Қос сабақ')}</td>
            <td width="160">{t('students.lesson_order','Сабақ реті')}</td>
            <td width="160">{t('students.time_col','уақыты')}</td>
            <td width="160">{t('students.break_col','үзіліс')}</td>
            </tr>
            <tr>
            <td width="159">1</td>
            <td width="160">1</td>
            ...
            <p>&nbsp;</p>
            <p>{t('students.shift2','2 ауысым')}</p>
            <table border="1px" className={styles.timetable}>
            <tbody>
            <tr>
            <td width="159">{t('students.double_lesson','Қос сабақ')}</td>
